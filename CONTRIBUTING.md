...
If you have found what you think is a bug, please [file an issue](https://github.com/VGLoic/metamask-react/issues/new).
...
`metamask-react` is using [Angular Commit Message Conventions](https://github.com/angular/angular.js/blob/master/DEVELOPERS.md#-git-commit-guidelines).
